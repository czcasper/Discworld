...
public class CoordinateInterpolator extends X3DObject {
     ...
     */
    @XmlAttribute
    protected List<Double> key;

    /**
     * Defines the set of data points, that are used for interpolation.The number of coordinates in the keyValue field shall be an integer
     * multiple of the number of key frames in the key field. That integer multiple defines how many coordinates will be contained in the
    ...
    /**
     * The set_fraction inputOnly field receives an SFDouble event and causes the interpolator node function to evaluate, resulting in a
    ...
    /**
     * Get list of key value vectors used by coordinates interpolation.
     *
    ...
    /**
     * Set list of key values used by curent instance for coordinates interpolation.
     *
     ...
     */
    public void setKey(List<Double> key) {
        this.key = key;
    }
